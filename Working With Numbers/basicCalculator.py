...
num = 0
while int(num) != 5 :
# This is the input reciever, and it can collect 2 strings and print them.
...
# strings into usable integers for my equations to work. Side Note : I need to catch exeptions for decimals entered in as I do not have float entered in.
    match int(num):
        case 1:
